...
;; Modificato il calcolo del punteggio finale
(deffunction scoring (?fok ?fko ?gok ?gko ?saf ?sink)
	(- (+ (* ?fok 10) (* ?gok 10) (* ?sink 15) )  (+ (* ?fko 25) (* ?gko 15) (* ?saf 10)))
	; (- (+ (* ?fok 20) (* ?gok 10) (* ?sink 25) )  (+ (* ?fko 25) (* ?gko 5) (* ?saf 5)))
...
(defrule make-visible-middle (declare (salience 0))
	(fire ?x ?y)
	(cell (x ?x) (y ?y) (content boat))
	(not (k-cell (x ?x) (y ?y) ) )
=>
